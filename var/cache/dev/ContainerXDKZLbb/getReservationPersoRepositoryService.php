 ...
 */
class getReservationPersoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReservationPersoRepository' shared autowired service.
     *
     * @return \App\Repository\ReservationPersoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservationPersoRepository.php';

        return $container->privates['App\\Repository\\ReservationPersoRepository'] = new \App\Repository\ReservationPersoRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
