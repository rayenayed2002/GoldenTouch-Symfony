 ...
 */
class getUserratingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserratingRepository' shared autowired service.
     *
     * @return \App\Repository\UserratingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserratingRepository.php';

        return $container->privates['App\\Repository\\UserratingRepository'] = new \App\Repository\UserratingRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
