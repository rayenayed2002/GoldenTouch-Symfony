 ...
 */
class getReserverLieuRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReserverLieuRepository' shared autowired service.
     *
     * @return \App\Repository\ReserverLieuRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReserverLieuRepository.php';

        return $container->privates['App\\Repository\\ReserverLieuRepository'] = new \App\Repository\ReserverLieuRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
