 ...
 */
class getPack2RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Pack2Repository' shared autowired service.
     *
     * @return \App\Repository\Pack2Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Pack2Repository.php';

        return $container->privates['App\\Repository\\Pack2Repository'] = new \App\Repository\Pack2Repository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
