 ...
 */
class getPackPersonnelRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PackPersonnelRepository' shared autowired service.
     *
     * @return \App\Repository\PackPersonnelRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PackPersonnelRepository.php';

        return $container->privates['App\\Repository\\PackPersonnelRepository'] = new \App\Repository\PackPersonnelRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
