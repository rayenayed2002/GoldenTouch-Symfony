 ...
 */
class getNotificationsAdminRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NotificationsAdminRepository' shared autowired service.
     *
     * @return \App\Repository\NotificationsAdminRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NotificationsAdminRepository.php';

        return $container->privates['App\\Repository\\NotificationsAdminRepository'] = new \App\Repository\NotificationsAdminRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
