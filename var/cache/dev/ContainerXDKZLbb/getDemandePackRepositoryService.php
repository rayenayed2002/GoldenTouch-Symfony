 ...
 */
class getDemandePackRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DemandePackRepository' shared autowired service.
     *
     * @return \App\Repository\DemandePackRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DemandePackRepository.php';

        return $container->privates['App\\Repository\\DemandePackRepository'] = new \App\Repository\DemandePackRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
