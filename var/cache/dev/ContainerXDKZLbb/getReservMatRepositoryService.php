 ...
 */
class getReservMatRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReservMatRepository' shared autowired service.
     *
     * @return \App\Repository\ReservMatRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservMatRepository.php';

        return $container->privates['App\\Repository\\ReservMatRepository'] = new \App\Repository\ReservMatRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
