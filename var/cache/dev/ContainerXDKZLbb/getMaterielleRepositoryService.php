 ...
 */
class getMaterielleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MaterielleRepository' shared autowired service.
     *
     * @return \App\Repository\MaterielleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MaterielleRepository.php';

        return $container->privates['App\\Repository\\MaterielleRepository'] = new \App\Repository\MaterielleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
