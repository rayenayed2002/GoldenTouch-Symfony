 ...
 */
class getDetailPaymentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DetailPaymentRepository' shared autowired service.
     *
     * @return \App\Repository\DetailPaymentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DetailPaymentRepository.php';

        return $container->privates['App\\Repository\\DetailPaymentRepository'] = new \App\Repository\DetailPaymentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
