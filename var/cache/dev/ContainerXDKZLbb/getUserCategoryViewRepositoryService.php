 ...
 */
class getUserCategoryViewRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserCategoryViewRepository' shared autowired service.
     *
     * @return \App\Repository\UserCategoryViewRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserCategoryViewRepository.php';

        return $container->privates['App\\Repository\\UserCategoryViewRepository'] = new \App\Repository\UserCategoryViewRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
