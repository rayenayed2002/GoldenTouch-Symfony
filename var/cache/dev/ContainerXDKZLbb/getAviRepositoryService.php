 ...
 */
class getAviRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AviRepository' shared autowired service.
     *
     * @return \App\Repository\AviRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AviRepository.php';

        return $container->privates['App\\Repository\\AviRepository'] = new \App\Repository\AviRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
