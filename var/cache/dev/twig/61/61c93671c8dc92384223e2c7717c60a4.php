...
class __TwigTemplate_1aebf5f1a3e7bec796b69deb75b8b0eb extends Template
{
...
<script>
    ...
    if (isUpdate) {
        const imageFile = formData.get('imageUrl'); // Changed from 'image' to 'imageUrl'
        if (imageFile) {
   ...
   function editLocation(id) {
    fetch(`/admin/lieu/\${id}/edit`, {  // Changed from /update to /edit
        headers: {
            'X-Requested-With': 'XMLHttpRequest'
        }
    })
    ...
    .then(data => {
        if (data.success) {
            ...
            if (lieu.imageUrl) {
                ...
                \$('#currentImagePreview').attr('src', `/uploads/lieux/\${lieu.imageUrl}`);
            } else {
                \$('#currentImageContainer').hide();
            }
    ...
    {
        return array (  935 => 698,  762 => 528,  690 => 459,  686 => 458,  682 => 457,  678 => 456,  672 => 453,  668 => 452,  664 => 451,  660 => 450,  656 => 449,  652 => 448,  648 => 447,  560 => 361,  544 => 351,  534 => 344,  527 => 340,  523 => 339,  519 => 338,  514 => 336,  509 => 334,  505 => 333,  501 => 332,  498 => 331,  494 => 329,  486 => 327,  484 => 326,  480 => 324,  476 => 323,  455 => 304,  441 => 296,  435 => 293,  429 => 290,  418 => 282,  411 => 278,  404 => 274,  393 => 266,  388 => 264,  383 => 262,  379 => 261,  375 => 259,  369 => 255,  367 => 254,  364 => 253,  358 => 249,  350 => 247,  348 => 246,  344 => 244,  340 => 243,  299 => 205,  290 => 199,  122 => 34,  118 => 33,  114 => 32,  110 => 31,  106 => 30,  102 => 29,  98 => 28,  94 => 27,  88 => 24,  84 => 23,  80 => 22,  74 => 19,  70 => 18,  59 => 10,  48 => 1,);
    }
