...
/* base.html.twig */
class __TwigTemplate_cf118a34cecf9861b2db3baffb55006c extends Template
{
...
<link rel=\"stylesheet\" href=\"";
        // line 47
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("Front/css/search.css"), "html", null, true);
        yield "\">
                        ...
                        <ul>
                            ...
                            <li class=\"menu-item-has-children\">
                                ...
                                <ul class=\"sub-menu\">
                                    ";
        // line 339
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 339, $this->source); })()), "user", [], "any", false, false, false, 339)) {
            yield " 
                                    ";
            // line 340
        ...
        yield "                                </ul>
                ...
                <div class=\"col-auto d-none d-xl-block\">
                    <div class=\"header-button\">
                        <div class=\"search-container d-inline-block me-2\">
...
\t\t\t\t<div class=\"th-page-content-body\">
\t\t\t\t\t";
        // line 409
...
<script src=\"";
        // line 539
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("Front/js/search.js"), "html", null, true);
        yield "\"></script>
...
";
    ...
    {
        return array (  795 => 409,  772 => 7,  755 => 539,  751 => 538,  746 => 536,  741 => 534,  736 => 532,  731 => 530,  727 => 529,  722 => 527,  717 => 525,  712 => 523,  707 => 521,  702 => 519,  650 => 470,  588 => 410,  586 => 409,  577 => 403,  521 => 349,  516 => 347,  511 => 346,  506 => 344,  501 => 343,  495 => 341,  493 => 340,  489 => 339,  474 => 327,  386 => 242,  369 => 228,  326 => 188,  314 => 179,  302 => 170,  290 => 161,  278 => 152,  208 => 85,  167 => 47,  163 => 46,  159 => 45,  155 => 44,  151 => 43,  147 => 42,  143 => 41,  129 => 30,  124 => 28,  120 => 27,  116 => 26,  112 => 25,  108 => 24,  104 => 23,  100 => 22,  96 => 21,  92 => 20,  88 => 19,  84 => 18,  80 => 17,  76 => 16,  72 => 15,  61 => 7,  53 => 2,  50 => 1,);
    }
                        ...
                        <ul>
                            ...
                            <li class=\"menu-item-has-children\">
                                ...
                                <ul class=\"sub-menu\">
                                    ...
                                    <li><a href=\"{{ path('admin_dashboard_index') }}\">Admin Dashboard</a></li>
                                    {% endif %}
\t\t\t\t\t\t\t\t\t<li><a href=\"{{ path('user_account_index') }}\">Profile</a></li>
                                    <li><a href=\"{{ logout_path('main') }}\">Logout</a></li>
                                    {% else %}
                                    <li><a href=\"{{ path('login') }}\">Login</a></li>
                                    <li><a href=\"{{ path('registration') }}\">Register</a></li>
                                    {% endif %}
                                </ul>
                            </li>
                            <li class=\"menu-item-has-children\">
...
", "base.html.twig", "C:\\Users\\ASUS\\Desktop\\souha\\GoldenTouch-Symfony\\templates\\base.html.twig");
    }
}
