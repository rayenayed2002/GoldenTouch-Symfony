...
class __TwigTemplate_e565ed86f6c62456f1e56501b911dc42 extends Template
{
...
<body style=\"outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; margin: 0; padding: 0; border: 0;\">
    ...
    ";
        // line 13
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["const_website_title"]) || array_key_exists("const_website_title", $context) ? $context["const_website_title"] : (function () { throw new RuntimeError('Variable "const_website_title" does not exist.', 13, $this->source); })()), "html", null, true);
        yield "                                                                                         
    </div>
    ...
    <table valign=\"top\" class=\"bg-light body\" style=\"outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; margin: 0; padding: 0; border: 0;\" bgcolor=\"#f8f9fa\">
        ...
        // line 52
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["const_website_title"]) || array_key_exists("const_website_title", $context) ? $context["const_website_title"] : (function () { throw new RuntimeError('Variable "const_website_title" does not exist.', 52, $this->source); })()), "html", null, true);
        yield "</h4>
        ...
        // line 53
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate((isset($context["date"]) || array_key_exists("date", $context) ? $context["date"] : (function () { throw new RuntimeError('Variable "date" does not exist.', 53, $this->source); })()), "d/m/Y"), "html", null, true);
        yield " à ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate((isset($context["date"]) || array_key_exists("date", $context) ? $context["date"] : (function () { throw new RuntimeError('Variable "date" does not exist.', 53, $this->source); })()), "H:i:s"), "html", null, true);
        yield "</h5>
        ...
        // line 97
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["url"]) || array_key_exists("url", $context) ? $context["url"] : (function () { throw new RuntimeError('Variable "url" does not exist.', 97, $this->source); })()), "html", null, true);
        yield "\">Réinitialiser mon mot de passe</a>
                                                                                            ...
                                                                                            <!-- Add direct link as fallback with additional debug info -->
                                                                                            <div style=\"margin-top: 20px; text-align: center; font-size: 14px; color: #6c757d;\">
                                                                                                Si le bouton ne fonctionne pas, copiez et collez ce lien dans votre navigateur:
                                                                                                <br>
                                                                                                <a href=\"";
        // line 107
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["url"]) || array_key_exists("url", $context) ? $context["url"] : (function () { throw new RuntimeError('Variable "url" does not exist.', 107, $this->source); })()), "html", null, true);
        yield "\" style=\"word-break: break-all; color: #4e73df;\">";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["url"]) || array_key_exists("url", $context) ? $context["url"] : (function () { throw new RuntimeError('Variable "url" does not exist.', 107, $this->source); })()), "html", null, true);
        yield "</a>
                                                                                                <div style=\"margin-top: 10px; font-size: 12px; color: #999;\">
                                                                                                    Token: ";
        // line 109
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 109, $this->source); })()), "token", [], "any", false, false, false, 109), "html", null, true);
        yield "
                                                                                                </div>
                                                                                            </div>
    ...
    {
        return array (  177 => 109,  170 => 107,  157 => 97,  108 => 53,  104 => 52,  62 => 13,  48 => 1,);
    }
                                                                                    ...
                                                                                    <td style=\"border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;\" align=\"left\">
                                                                                        <div>
                                                                                            ...
                                                                                            <div style=\"margin-top: 20px; text-align: center; font-size: 14px; color: #6c757d;\">
                                                                                                Si le bouton ne fonctionne pas, copiez et collez ce lien dans votre navigateur:
                                                                                                <br>
                                                                                                <a href=\"{{ url }}\" style=\"word-break: break-all; color: #4e73df;\">{{ url }}</a>
                                                                                                <div style=\"margin-top: 10px; font-size: 12px; color: #999;\">
