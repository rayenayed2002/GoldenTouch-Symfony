...
class __TwigTemplate_f81f24681ae28912256301d4e3219b05 extends Template
{
    ...
    // line 1
    public function macro_is_active($segment = null, ...$varargs): string|Markup
    {
        $macros = $this->macros;
        $context = [
            "segment" => $segment,
