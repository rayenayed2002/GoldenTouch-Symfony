...
class __TwigTemplate_937263ba3bab8c4187304c67861cec97 extends Template
{
...
$context["review"], "note", [], "any", true, true, false, 322) && ($context["i"] <= (CoreExtension::getAttribute($this->env, $this->source, $context["review"], "note", [], "any", false, false, false, 322) + 0.5)))) {
    ...
    <script>
        ...
        yield ",
                    ...
                    fetch('";
        // line 840
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_demande_pack_create");
        yield "', {
                        method: 'POST',
                        headers: {
        ...
        function sharePack() {
            if (navigator.share) {
                navigator.share({
                    title: '";
        // line 945
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["pack"]) || array_key_exists("pack", $context) ? $context["pack"] : (function () { throw new RuntimeError('Variable "pack" does not exist.', 945, $this->source); })()), "nom", [], "any", false, false, false, 945), "html", null, true);
        yield "',
                    text: '";
        // line 946
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::striptags(CoreExtension::getAttribute($this->env, $this->source, (isset($context["pack"]) || array_key_exists("pack", $context) ? $context["pack"] : (function () { throw new RuntimeError('Variable "pack" does not exist.', 946, $this->source); })()), "description", [], "any", false, false, false, 946)), "html", null, true);
        yield "',
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (bookingForm) {
                bookingForm.addEventListener('submit', function(e) {
                    ...
                    // Send request to create demande pack
                    fetch('{{ path('app_demande_pack_create') }}', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-Requested-With': 'XMLHttpRequest'
