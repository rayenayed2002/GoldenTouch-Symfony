...
return [
    ...
    'admin_user_toggle_verify' => [['id'], ['_controller' => 'App\\Controller\\AdminUserController::toggleVerify'], [], [['text', '/toggle-verify'], ['variable', '/', '[^/]++', 'id', true], ['text', '/admin/utilisateur']], [], [], []],
    ...
    'force_reset_password' => [[], ['_controller' => 'App\\Controller\\ResetPasswordController::forceResetPassword'], [], [['text', '/mot-de-passe/force-reset']], [], [], []],
    'debug_reset_link' => [['email'], ['_controller' => 'App\\Controller\\ResetPasswordController::debugGenerateResetLink'], [], [['variable', '/', '[^/]++', 'email', true], ['text', '/mot-de-passe/debug/reset-link']], [], [], []],
    ...
    'user_account_edit' => [[], ['_controller' => 'App\\Controller\\UserAccountController::edit'], [], [['text', '/user/profiledition']], [], [], []],
    'user_account_index' => [[], ['_controller' => 'App\\Controller\\UserAccountController::index'], [], [['text', '/user/profil']], [], [], []],
