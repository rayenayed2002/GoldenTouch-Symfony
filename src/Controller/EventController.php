...
class EventController extends AbstractController
{
    ...
    public function draftEvents(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $qbDemande = $entityManager->createQueryBuilder()
            ...
            ->leftJoin('e.paniers', 'p')
            ->leftJoin('e.detailPayments', 'dc')
            ->where('dp.statut = :statutConfirme')
        ...
        usort($events, function($a, $b) use ($orderBy, $sortDirection) {
            switch ($orderBy) {
                ...
                case 'date':
                    ...
                    break;
                case 'category':
                    $valA = $a->getCategorie()->value; // Assuming CategoryEnum is an enum
        ...
        // Category labels
        $categoryLabels = [
            CategoryEnum::MARIAGE->value => 'Mariage',
            CategoryEnum::ANNIVERSAIRE->value => 'Anniversaire',
            CategoryEnum::CONFERENCE->value => 'Conférence',
            CategoryEnum::CONCERT->value => 'Concert',
            CategoryEnum::SEMINAIRE->value => 'Séminaire',
            CategoryEnum::FESTIVAL->value => 'Festival',
            CategoryEnum::SPORT->value => 'Sport',
            CategoryEnum::ATELIER->value => 'Atelier',
        ];
    ...
    public function edit(
        ...
        try {
            ...
            $event
                ...
                ->setCategorie(CategoryEnum::from($categorie));
    ...
    public function EventShow(
        ...
        return $this->render('GestionEvent/DetailEvent.html.twig', [
            ...
            'categorie_options' => CategoryEnum::cases(),
        ]);
    }
