...
class EmailServiceP
{
    ...
    {
        try {
            $emailBody = $this->generateEmailBody($user, $totalPrice, $paymentId);
    ...
    private function generateEmailBody($user, $totalPrice, $paymentId): string
    {
        return sprintf('
            <html>
            <head>
                ...
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <table class="details-table">
                            <tr><td>Montant total</td><td><span class="highlight">%.2f TND</span></td></tr>
                            <tr><td>Numéro de commande</td><td>%d</td></tr>
